...
{
    public partial class FrmDmDC_ICD_YHCT : FrmBase
    {


        public FrmDmDC_ICD_YHCT()
        {
            InitializeComponent();
        ...
        protected override void OnInit()
        {
            try
            {
                DataTable dataTable = SQLHelper.ExecuteDataTable(string.Format("SELECT * FROM tblDmDC_ICD10"));
